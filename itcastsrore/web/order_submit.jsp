...
<%--				<div class="row">--%>
<%--					<label class="control-label col-md-1">确认邮箱</label>--%>
<%--					<div class="col-md-6">--%>
<%--						<input type="text" class="form-control" name="email" value="${user.email }" style="height:auto;padding:10px;" placeholder="输入邮箱" required="required"><br>--%>
<%--					</div>--%>
<%--				</div>--%>
				<div class="row">
